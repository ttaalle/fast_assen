...
class BalancedIdentitySampler(Sampler):
    def __init__(self, data_source: List, mini_batch_size: int, num_instances: int, seed: Optional[int] = None):
        ...
        self.pid_model = defaultdict(list)
        self.pid_color = defaultdict(list)
        self.pid_type = defaultdict(list)
        ...
        for index, info in enumerate(data_source):
            ...
            self.pid_time[pid].append(timeid)
            self.pid_model[pid].append(modelid)
            self.pid_color[pid].append(colorid)
            self.pid_type[pid].append(typeid)
    ...
    def _infinite_indices(self):
        ...
        while True:
            ...
            for kid in identities:
                ...
                _, i_pid, i_cam, i_vid, i_tid, i_moid, i_coid, i_tyid = self.data_source[i]
                batch_indices.append(i)
                pid_i = self.index_pid[i]
                cams = self.pid_cam[pid_i]
                views = self.pid_view[pid_i]
                times = self.pid_time[pid_i]
                models = self.pid_model[pid_i]
                colors = self.pid_color[pid_i]
                types = self.pid_type[pid_i]
